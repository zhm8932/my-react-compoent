...
gulp.task('webpackStream', function(){
    gulp.src([PATHS.clientJs,PATHS.clientJsx,PATHS.compomentJs])
        .pipe(named())
...
gulp.task('watch',function () {
    ...
    gulp.watch([PATHS.clientJs,PATHS.clientJsx,PATHS.compomentJs],['webpack']);                //webpackDev 任务监控文件打包速度 在100ms左右 ,页面第一次修改时不会自动刷新
